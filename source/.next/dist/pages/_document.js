...
var MyDocument = function (_Document) {
  ...
  (0, _createClass3.default)(MyDocument, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('html', null, _react2.default.createElement(_document.Head, null, _react2.default.createElement('meta', { property: 'og:url', content: 'https://dev-songkran.github.io' }), _react2.default.createElement('meta', { property: 'og:type', content: 'portfolio' }), _react2.default.createElement('meta', { property: 'og:title', content: 'My Portfolio, built in next.js and React' }), _react2.default.createElement('meta', { property: 'og:description', content: 'My name is Songkran Wichitpong. I\u2019m the Front-end Dev. from Thailand. ' }), _react2.default.createElement('meta', { property: 'og:image', content: 'https://dev-songkran.github.io/static/media/my.1bda1d7a.jpg' }), _react2.default.createElement('meta', { property: 'og:site_name', content: 'dev-songkran.github.io' }), _react2.default.createElement('meta', { property: 'fb:app_id', content: '169032400358673' }), _react2.default.createElement('meta', { name: 'twitter:card', content: 'summary' }), _react2.default.createElement('meta', { name: 'twitter:site', content: '@dev_Songkran' }), _react2.default.createElement('meta', { name: 'twitter:creator', content: '@dev_Songkran' }), _react2.default.createElement('meta', { name: 'viewport', content: 'initial-scale=1.0, width=device-width' }), _react2.default.createElement('meta', { 'http-equiv': 'cache-control', content: 'no-cache' }), _react2.default.createElement('meta', { 'http-equiv': 'expires', content: '0' }), _react2.default.createElement('meta', { 'http-equiv': 'pragma', content: 'no-cache' }), _react2.default.createElement('title', null, 'My Portfolio, built in next.js and React'), _react2.default.createElement('link', { href: 'https://fonts.googleapis.com/css?family=Athiti:300,400', rel: 'stylesheet' }), _react2.default.createElement('link', { href: 'https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css', rel: 'stylesheet' }), _react2.default.createElement('style', { dangerouslySetInnerHTML: { __html: resetStyles } }), styleElements), _react2.default.createElement('body', null, _react2.default.createElement('noscript', { dangerouslySetInnerHTML: { __html: '<iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WDWNSLK" height="0" width="0" style="display:none;visibility:hidden"></iframe>' } }), _react2.default.createElement(_document.Main, null), _react2.default.createElement(_document.NextScript, null)));
    }
  }], [{
    key: 'getInitialProps',
